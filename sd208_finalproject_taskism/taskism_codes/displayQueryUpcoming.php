...
if (isset($_POST['upcoming'])) {
    ...
    if (mysqli_num_rows($result) > 0) {?>
        ...
        <?php if (!isset($_SESSION['alert_upcoming'])) { ?>
        <script>
            setTimeout("alert('You have <?php echo $rows ?> upcoming task/s to be done today! Start doing it now, better days too soon than a minute late!');", 5000);
        </script>
        <?php $_SESSION['alert_upcoming'] = 'upcoming'; }?>
